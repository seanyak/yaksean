  ...
  return (
    <html lang="en" className="!scroll-smooth">
      <body 
        ...
        <div className='bg-[#fefce8] absolute top-[-6rem] -z-10 right-[11rem] h-[31.25rem] w-[31.25rem] rounded-full blur-none lg:blur-[29rem] sm:w-[68.75rem] dark:bg-[#022c22]'></div>
        <div className='bg-[#bae6fd] absolute top-[-1rem] -z-10 left-[-35rem] h-[31.25rem] w-[50rem] rounded-full blur-none lg:blur-[29rem] sm:w-[68.75rem] md:left-[-33rem] lg:left-[-28rem] xl:left-[-15rem] 2xl:left-[-5rem] dark:bg-[#0c4a6e]'></div>        <ThemeContextProvider>
