  ...
  return (
    <html lang="en" className="!scroll-smooth">
      <body 
        ...
        <div className='bg-[#fefce8] absolute top-[-6rem] -z-10 right-[11rem] h-[20rem] w-[20rem] rounded-full blur-3xl opacity-40'></div>
        <div className='bg-[#bae6fd] absolute top-[-1rem] -z-10 left-[-10rem] h-[20rem] w-[20rem] rounded-full blur-3xl opacity-40'></div>        <ThemeContextProvider>
